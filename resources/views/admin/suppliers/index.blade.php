                    ...
                    @foreach ($suppliers as $supplier)
                        ...
                        <tr class="border-t">
                            ...
                            <td class="px-6 py-4 text-right space-x-3">
                                ...
                                <button
                                    onclick="window.dispatchEvent(new CustomEvent('open-modal', {detail: 'edit-supplier-{{ $supplier->id }}'}))"
                                ...
                                <form
                                    ...
                                    class="inline"
                                    onsubmit="return confirm('Remove this supplier and its login?')">
                        ...
                        <x-modal name="edit-supplier-{{ $supplier->id }}" max-width="2xl">
                            ...
                            <form method="POST" action="{{ route('admin.suppliers.update', $supplier) }}">
                                ...
                                <div class="px-6 py-5 grid grid-cols-2 gap-4">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea
                                            name="notes"
                                            rows="3"
                                            class="w-full rounded-lg border-slate-200 text-sm">{{ $supplier->notes }}</textarea>
                                ...
                                <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-100">
                                    ...
                                    <button
                                        type="submit"
                                        class="rounded-lg bg-brand-500 hover:bg-brand-600 text-white text-sm font-medium px-4 py-2">
                                        Save Changes
                                    </button>
        ...
        <form
            ...
            <div class="px-6 py-5 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <label class="block text-sm font-medium text-slate-700 mb-1.5">
                        Login email <span class="text-red-400">*</span>
                    </label>
                    ...
                    <p class="text-xs text-slate-400 mt-1">
                        This is also the supplier's sign-in email.
                    </p>
                ...
                <div>
                    ...
                    <label class="block text-sm font-medium text-slate-700 mb-1.5">
                        Login password <span class="text-red-400">*</span>
                    </label>
                ...
                <div class="col-span-2">
                    ...
                    <textarea
                        name="notes"
                        rows="4"
                        class="w-full rounded-lg border-slate-200 text-sm"></textarea>
